...
# который будет создавать новую таблицу с двумя колонками: id и name.
# Типы данных колонок INT и TEXT соответственно. Если таблица уже существует,
# метод должен выводить сообщение об ошибке
